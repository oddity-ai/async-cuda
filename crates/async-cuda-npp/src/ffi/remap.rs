...
pub fn remap(
    ...
    map_x: &async_cuda_core::ffi::memory::DeviceBuffer2D<f32>,
    map_y: &async_cuda_core::ffi::memory::DeviceBuffer2D<f32>,
    context: &Context,
) -> Result<()> {
...
mod tests {
    ...
    fn test_remap() {
        ...
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(4, 4, 3);
    ...
    fn test_it_panics_when_input_num_channels_incorrect() {
        ...
        let map_x = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 1);
        let map_y = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 1);
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
    ...
    fn test_it_panics_when_output_num_channels_incorrect() {
        ...
        let map_x = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 1);
        let map_y = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 1);
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 2);
        remap(&input, &mut output, &map_x, &map_y, &context).unwrap();
    }
    ...
    fn test_it_panics_when_map_num_channels_incorrect() {
        let context = Context::from_null_stream();
        let input = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        let map_x = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 2);
        let map_y = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 100, 3);
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        remap(&input, &mut output, &map_x, &map_y, &context).unwrap();
    }
    ...
    fn test_it_panics_when_map_width_incorrect() {
        let context = Context::from_null_stream();
        let input = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        let map_x = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(120, 100, 1);
        let map_y = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(120, 100, 1);
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        remap(&input, &mut output, &map_x, &map_y, &context).unwrap();
    }
    ...
    fn test_it_panics_when_map_height_incorrect() {
        let context = Context::from_null_stream();
        let input = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        let map_x = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 120, 1);
        let map_y = async_cuda_core::ffi::memory::DeviceBuffer2D::<f32>::new(100, 120, 1);
        let mut output = async_cuda_core::ffi::memory::DeviceBuffer2D::<u8>::new(100, 100, 3);
        remap(&input, &mut output, &map_x, &map_y, &context).unwrap();
    }
}
